...
export default function Technology() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="py-24 text-center min-h-[60vh] flex items-center">
          ...
          >
            {features.map((feature) => (
              <motion.div key={feature.title} variants={scaleIn}>
                <Card className="border-none shadow-none bg-transparent hover:bg-background/50 transition-colors duration-300 p-6 h-full">
                  <CardHeader>
          ...
          >
            {stats.map((stat) => (
              <motion.div key={stat.label} variants={fadeInUp} className="text-center">
                <div className="text-3xl font-bold transition-transform duration-300 hover:scale-110 inline-block">
                  {stat.value}
                </div>
